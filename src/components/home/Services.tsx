    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="w-14 h-14 bg-[#E0FF4F] rounded-xl flex items-center justify-center">
          <div className="relative w-8 h-8 flex items-center justify-center">
            <div className="w-7 h-8 bg-[#F472B6] transform rotate-[-12deg] relative"
              ...
              <div className="absolute top-0 left-0 w-[25%] h-[25%] bg-[#EC4899]"
                style={{ clipPath: 'polygon(0 100%, 100% 0, 0 0)' }}></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="bg-[#F9FAFF] rounded-xl p-4 text-center">
          ...
          <div className="text-xs text-[#4A4A4A] mt-1">Встроен эквайринг</div>
        </div>
      </div>
    </div>
  )
